...
PanelWindow {
    ...
    Rectangle {
        ...
        anchors.topMargin: if (panelStats == "expanded" || panelStats == "semiexpanded" || panelStats == "volume") { 
            panel.margin
        } else {
        ...
        height: if (panelStats == "expanded") {
            panel.expandedpanelheight + listData[panel.currentIndex].extraHeight
        } else {
            panel.panelheight
        }
        ...
        Rectangle {
            ...
            anchors.leftMargin: if (panelStats == "volume") {
                10 + currentIndex * 35 + volume * 155 // i love magic numbers
            } else {
                10 + currentIndex * 35
            }
